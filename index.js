      ...
      if (input_value.length === 0) {
        ...
        $.getJSON('/', {
          ...
          gen_help.html(subjects.reduce((accumulator, currentValue) => {
            return accumulator += "<tr><td>" + currentValue.year + "</td><td>" + currentValue.subtype + "</td><td>" + currentValue.title + (currentValue.subtitle && currentValue.subtitle !== currentValue.title ? (' / ' + currentValue.subtitle) : '' ) + "</td><td><a href='" + currentValue.link + "' target='_blank'>" + currentValue.link + "</a></td><td><a href='javascript:void(0);' class='gen-search-choose' data-url='" + currentValue.link + "'>选择</a></td></tr>";
